<%@ Control Language="C#" AutoEventWireup="true" CodeFile="View_Previous.ascx.cs" Inherits="View_Previous" %>
<p>
    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;<asp:Label ID="Label1" runat="server" Text="Days Only"></asp:Label>
</p>
<asp:DataGrid ID="DataGridPre" runat="server" BackColor="#DEBA84" AutoGenerateColumns="false"
    BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
    CellSpacing="2" align="center" 
    onselectedindexchanged="DataGridPre_SelectedIndexChanged">
